defmodule IndexingReporterWeb.Router do
  use IndexingReporterWeb, :router

  import IndexingReporterWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {IndexingReporterWeb.LayoutView, :root}
  ...
  # scope "/api", IndexingReporterWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: IndexingReporterWeb.Telemetry
    end
  end
